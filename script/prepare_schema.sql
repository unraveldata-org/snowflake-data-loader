...
queries[0] = 'create or replace TABLE '+dbName+'.'+schemaName+'.ACCESS_HISTORY (QUERY_ID VARCHAR(128),QUERY_START_TIME TIMESTAMP_LTZ(9),USER_NAME VARCHAR(128),DIRECT_OBJECTS_ACCESSED ARRAY,BASE_OBJECTS_ACCESSED ARRAY,OBJECTS_MODIFIED ARRAY,OBJECT_MODIFIED_BY_DDL OBJECT,POLICIES_REFERENCED ARRAY) CLUSTER BY (QUERY_START_TIME);';
