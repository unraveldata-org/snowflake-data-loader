...
queries[13]='create or replace TABLE '+dbName+'.'+schemaName+'.DATABASE_STORAGE_USAGE_HISTORY (USAGE_DATE DATE, DATABASE_ID NUMBER(38,0), DATABASE_NAME VARCHAR(16777216), DELETED TIMESTAMP_LTZ(6), AVERAGE_DATABASE_BYTES FLOAT, AVERAGE_FAILSAFE_BYTES FLOAT);';
