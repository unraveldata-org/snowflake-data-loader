...
ALTER TABLE QUERY_HISTORY ADD COLUMN INSERT_TIME TIMESTAMP_LTZ;

CREATE OR REPLACE TRANSIENT TABLE SESSIONS WITH
DATA_RETENTION_TIME_IN_DAYS=0 LIKE SNOWFLAKE.ACCOUNT_USAGE.SESSIONS;
ALTER TABLE SESSIONS ADD COLUMN INSERT_TIME TIMESTAMP_LTZ;
...
ALTER TABLE ACCESS_HISTORY ADD COLUMN INSERT_TIME TIMESTAMP_LTZ;
