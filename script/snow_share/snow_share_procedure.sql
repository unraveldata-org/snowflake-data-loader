...
*/
CALL create_table_from_snowflake($DATABASE_TO_SHARE, $SCHEMA_TO_SHARE , 'QUERY_HISTORY');
CALL create_table_from_snowflake($DATABASE_TO_SHARE, $SCHEMA_TO_SHARE , 'ACCESS_HISTORY');
