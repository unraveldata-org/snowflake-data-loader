...
ALTER TABLE UNRAVEL_SHARE.SCHEMA_4827_T.TABLES ADD COLUMN LATEST_WRITE_TIME          TIMESTAMP_TZ;
ALTER TABLE UNRAVEL_SHARE.SCHEMA_4827_T.TABLES ADD COLUMN LATEST_ACCESS_TIME         TIMESTAMP_TZ;
ALTER TABLE UNRAVEL_SHARE.SCHEMA_4827_T.TABLES ADD COLUMN ACCESS_COUNT_LAST_15_DAYS  INTEGER;
ALTER TABLE UNRAVEL_SHARE.SCHEMA_4827_T.TABLES ADD COLUMN ACCESS_COUNT_LAST_30_DAYS  INTEGER;
ALTER TABLE UNRAVEL_SHARE.SCHEMA_4827_T.TABLES ADD COLUMN ACCESS_COUNT_LAST_45_DAYS  INTEGER;
ALTER TABLE UNRAVEL_SHARE.SCHEMA_4827_T.TABLES ADD COLUMN ACCESS_COUNT_LAST_60_DAYS  INTEGER;
ALTER TABLE UNRAVEL_SHARE.SCHEMA_4827_T.TABLES ADD COLUMN ACCESS_COUNT_LAST_90_DAYS  INTEGER;
ALTER TABLE UNRAVEL_SHARE.SCHEMA_4827_T.TABLES ADD COLUMN ACCESS_COUNT_LAST_180_DAYS  INTEGER;
ALTER TABLE UNRAVEL_SHARE.SCHEMA_4827_T.TABLES ADD COLUMN WRITE_COUNT_LAST_15_DAYS   INTEGER;
ALTER TABLE UNRAVEL_SHARE.SCHEMA_4827_T.TABLES ADD COLUMN WRITE_COUNT_LAST_30_DAYS   INTEGER;
ALTER TABLE UNRAVEL_SHARE.SCHEMA_4827_T.TABLES ADD COLUMN WRITE_COUNT_LAST_45_DAYS   INTEGER;
ALTER TABLE UNRAVEL_SHARE.SCHEMA_4827_T.TABLES ADD COLUMN WRITE_COUNT_LAST_60_DAYS   INTEGER;
ALTER TABLE UNRAVEL_SHARE.SCHEMA_4827_T.TABLES ADD COLUMN WRITE_COUNT_LAST_90_DAYS   INTEGER;
ALTER TABLE UNRAVEL_SHARE.SCHEMA_4827_T.TABLES ADD COLUMN WRITE_COUNT_LAST_180_DAYS   INTEGER;
...
AS
CALL REPLICATE_TABLES_WITH_ACCESS_METRICS('UNRAVEL_SHARE','SCHEMA_4827_T',2);
