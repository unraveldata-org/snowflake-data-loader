...
SET H_DAYS = '1';
SET DAYS_TO_KEEP = '5';
SET REPLICATE_METADATA_EVERY_12_HOURS = 'USING CRON 0 3,9,15,21 * * * UTC';
...
try {
   ...
   //Task 4 replicate_warehouse_and_realtime_query
    ...
    stmt.execute();
     ...
     //Task 6 create_shared_db_metadata
