...
CREATE OR REPLACE TABLE config_parameters (
    DATABASE_TO_SHARE STRING,
    SCHEMA_TO_SHARE STRING,
    SHARE_NAME STRING,
    PROFILE_QUERY_CREDIT STRING,
    ACCOUNT_ID STRING
);

INSERT INTO config_parameters (DATABASE_TO_SHARE, SCHEMA_TO_SHARE, SHARE_NAME, PROFILE_QUERY_CREDIT, ACCOUNT_ID) VALUES
...
*/
CALL create_table_from_snowflake((SELECT DATABASE_TO_SHARE FROM config_parameters LIMIT 1),  (SELECT SCHEMA_TO_SHARE FROM config_parameters LIMIT 1), 'QUERY_HISTORY');
CALL create_table_from_snowflake((SELECT DATABASE_TO_SHARE FROM config_parameters LIMIT 1),  (SELECT SCHEMA_TO_SHARE FROM config_parameters LIMIT 1) , 'ACCESS_HISTORY');
CALL CREATE_TABLES((SELECT DATABASE_TO_SHARE FROM config_parameters LIMIT 1),  (SELECT SCHEMA_TO_SHARE FROM config_parameters LIMIT 1));
CALL REPLICATE_ACCOUNT_USAGE((SELECT DATABASE_TO_SHARE FROM config_parameters LIMIT 1),  (SELECT SCHEMA_TO_SHARE FROM config_parameters LIMIT 1) ,2);
CALL REPLICATE_STORAGE_METADATA((SELECT DATABASE_TO_SHARE FROM config_parameters LIMIT 1),  (SELECT SCHEMA_TO_SHARE FROM config_parameters LIMIT 1), 2);
CALL REPLICATE_HISTORY_QUERY((SELECT DATABASE_TO_SHARE FROM config_parameters LIMIT 1),  (SELECT SCHEMA_TO_SHARE FROM config_parameters LIMIT 1) ,2);
CALL WAREHOUSE_PROC((SELECT DATABASE_TO_SHARE FROM config_parameters LIMIT 1),  (SELECT SCHEMA_TO_SHARE FROM config_parameters LIMIT 1));
CALL CREATE_QUERY_PROFILE(dbname => (SELECT DATABASE_TO_SHARE FROM config_parameters LIMIT 1), schemaname => (SELECT SCHEMA_TO_SHARE FROM config_parameters LIMIT 1), credit => (SELECT PROFILE_QUERY_CREDIT FROM config_parameters LIMIT 1), days => '2');
...
*/
CALL REPLICATE_REALTIME_QUERY_BY_WAREHOUSE((SELECT DATABASE_TO_SHARE FROM config_parameters LIMIT 1),  (SELECT SCHEMA_TO_SHARE FROM config_parameters LIMIT 1), 1);
...
AS
CALL CLEANUP_DATA( (SELECT DATABASE_TO_SHARE FROM config_parameters LIMIT 1),  (SELECT SCHEMA_TO_SHARE FROM config_parameters LIMIT 1));
...
*/
CALL SHARE_TO_ACCOUNT((SELECT ACCOUNT_ID FROM config_parameters LIMIT 1),  (SELECT SHARE_NAME FROM config_parameters LIMIT 1), (SELECT DATABASE_TO_SHARE FROM config_parameters LIMIT 1),  (SELECT SCHEMA_TO_SHARE FROM config_parameters LIMIT 1));
